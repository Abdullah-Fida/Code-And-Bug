      ...
      <section className="relative py-32 border-t border-gray-900 bg-[#02050B] overflow-hidden">
        ...
        <Reveal className="relative z-10 max-w-4xl mx-auto px-6 text-center flex flex-col items-center">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4">
            <a href="https://wa.me/923286403604" className="inline-flex items-center justify-center gap-2 px-8 py-3.5 text-sm font-bold text-white bg-[#25D366] hover:bg-[#20bd5a] rounded-xl transition-all shadow-[0_0_20px_rgba(37,211,102,0.3)]">
              <MessageCircle className="w-5 h-5" /> Chat on WhatsApp
            </a>
            <a href="#contact" className="inline-flex items-center justify-center px-8 py-3.5 text-sm font-bold text-gray-300 bg-transparent border border-gray-700 hover:border-gray-500 hover:text-white rounded-xl transition-all">
              Send a Message &rarr;
            </a>
          </div>
        </Reveal>
