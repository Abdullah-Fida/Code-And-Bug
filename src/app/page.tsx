...
export default function Home() {
  ...
  // Scroll-Spy for 6-Step Process (Only active on wide layouts to prevent bugs on phone layout heights)
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-[#030712] text-gray-100 font-sans selection:bg-cyan-500 selection:text-white relative overflow-x-hidden">
      ...
      <div className="w-full sticky top-4 z-50 px-4 sm:px-6">
        <header className="max-w-5xl mx-auto h-14 rounded-full border border-gray-800/80 bg-gray-950/70 backdrop-blur-xl flex items-center justify-between px-5 md:px-6 shadow-2xl shadow-black/50">
          ...
          <div className="flex items-center gap-2.5">
            <a href="#contact" className="inline-flex items-center justify-center px-3.5 py-1.5 text-[10px] md:text-[11px] font-bold uppercase tracking-wider text-white bg-cyan-600 rounded-full hover:bg-cyan-500 transition-all duration-300">
              Start Project
            </a>
      ...
      {/* Hero Section */}
      <section id="home" className="relative pt-12 pb-16 md:pt-24 md:pb-24 max-w-7xl mx-auto px-4 sm:px-6">
        <div className="absolute top-[-5%] left-1/4 w-[280px] sm:w-[600px] lg:w-[800px] h-[300px] bg-cyan-600/10 blur-[120px] rounded-full pointer-events-none z-[1]" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center relative z-10">
          <Reveal className="lg:col-span-7 space-y-5 md:space-y-7 text-center lg:text-left flex flex-col items-center lg:items-start">
            ...
            <h1 className="text-3xl sm:text-5xl xl:text-6xl font-extrabold tracking-tight text-white leading-[1.15] md:leading-[1.1] min-h-[140px] sm:min-h-[180px] lg:min-h-[140px]">
            ...
            <p className="text-sm sm:text-base md:text-lg text-gray-400 max-w-xl font-light leading-relaxed px-2 sm:px-0">
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-2 w-full sm:w-auto">
              <a href="#services" className="inline-flex items-center justify-center px-6 py-3 text-xs font-bold uppercase tracking-widest text-white bg-cyan-600 rounded-lg hover:bg-cyan-500 transition-all shadow-lg shadow-cyan-600/10">Explore Services</a>
              <a href="#contact" className="inline-flex items-center justify-center px-6 py-3 text-xs font-bold uppercase tracking-widest text-gray-400 bg-transparent rounded-lg hover:text-white transition-colors border border-gray-800">Let's Talk</a>
            </div>
          </Reveal>
      ...
      {/* About Section - Radar Canvas Layout */}
      <section id="about" className="py-16 md:py-24 border-t border-gray-900 bg-[#02050B]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <Reveal className="space-y-5 text-center lg:text-left max-w-2xl mx-auto lg:mx-0">
              ...
              <h2 className="text-2xl sm:text-4xl font-extrabold text-white leading-[1.2]">
              ...
              <ul className="space-y-3 pt-2 text-left inline-block lg:block max-w-md lg:max-w-none mx-auto">
                {[
            ...
            {/* Radar UI Adaptable Element */}
            <Reveal delay={200} className="relative w-full aspect-square max-w-[320px] sm:max-w-[420px] mx-auto flex items-center justify-center">
              ...
              <div className="relative z-10 w-28 h-28 sm:w-32 sm:h-32 bg-[#0b1120] border border-gray-700/80 rounded-2xl flex flex-col items-center justify-center shadow-2xl backdrop-blur-md">
                <div className="p-2 sm:p-2.5 bg-cyan-500/10 rounded-xl mb-2"><Network className="w-5 h-5 text-cyan-400" /></div>
                <div className="text-[9px] font-mono tracking-widest text-cyan-400 uppercase">AI Core</div>
                <div className="text-[11px] text-gray-400 mt-0.5">Always Learning</div>
              </div>
            </Reveal>
          </div>
        </div>
      ...
      {/* --- SERVICES SECTION --- */}
      <section id="services" className="py-16 md:py-24 border-t border-gray-900 bg-[#030712]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <Reveal className="mb-12 md:mb-16 text-center lg:text-left max-w-2xl mx-auto lg:mx-0">
            ...
            <p className="text-gray-400 font-light text-xs sm:text-sm md:text-base leading-relaxed">
          ...
          <Reveal delay={100} className="border border-gray-800/60 rounded-3xl overflow-hidden bg-gray-800/10 shadow-2xl">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-[1px]">
              {capabilities.map((tech, index) => (
                <div key={index} className="relative p-6 sm:p-8 lg:p-10 bg-[#0b1120] transition-all duration-300 group flex flex-col justify-between min-h-[360px] sm:min-h-[400px] hover:bg-[#080c16] overflow-hidden">
                  ...
                  <div className="flex justify-between items-start mb-6 relative z-10">
                    <div className="px-2.5 py-1 rounded-lg border border-gray-800 bg-[#030712]">
                      <span className="text-[10px] font-mono text-gray-500 group-hover:text-cyan-400 transition-colors duration-300">{tech.num}</span>
                    </div>
                    <div className="p-3 rounded-xl border border-gray-800 bg-[#030712] text-gray-500 group-hover:border-cyan-500/40 group-hover:text-cyan-400 transition-all duration-300">
                      {tech.icon}
                    </div>
                  </div>
                  ...
                  <div className="flex-1 relative z-10">
                    <div className="relative inline-block mb-3 sm:mb-4">
                      <h3 className="text-xl sm:text-2xl font-extrabold text-white">{tech.title}</h3>
                    </div>
                    <p className="text-xs sm:text-sm text-gray-400 leading-relaxed font-light mb-6 group-hover:text-gray-300 transition-colors duration-300">{tech.description}</p>
                    <ul className="space-y-2.5">
                      {tech.features.map((feature, fIdx) => (
                        <li key={fIdx} className="flex items-center gap-2.5 text-xs sm:text-[13px] text-gray-400 group-hover:text-gray-200 transition-colors font-light">
                  ...
                  <div className="mt-8 flex justify-between items-center relative z-10">
                    ...
                    <div className="w-8 h-8 rounded-full border border-gray-800 flex items-center justify-center text-gray-600 group-hover:border-cyan-500 group-hover:text-cyan-400 bg-[#030712] transition-all duration-300">
      ...
      <section id="process" className="py-16 md:py-24 border-t border-gray-900 bg-[#02050B]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <Reveal className="mb-10 md:mb-14 text-center lg:text-left">
            ...
            <p className="text-gray-400 font-light text-xs sm:text-sm md:text-base max-w-xl mx-auto lg:mx-0">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start relative">
            ...
            <Reveal delay={100} className="lg:col-span-5 relative z-10 pb-4 lg:pb-32">
              ...
              {processSteps.map((step, index) => {
                ...
                return (
                  <div key={index} id={`process-step-${index}`} data-step={index} onClick={() => scrollToStep(index)} className="process-step cursor-pointer relative pl-0 sm:pl-16 py-6 sm:py-10 lg:py-14 group border-b border-gray-900 sm:border-none">
                    <div className={`hidden sm:block absolute left-[13px] top-[54px] lg:top-[66px] w-[22px] h-[22px] rounded-full border-4 border-[#02050B] transition-colors duration-500 z-10 ${isActive ? 'bg-cyan-400 shadow-[0_0_15px_#06B6D4]' : 'bg-gray-700 group-hover:bg-gray-500'}`} />
                    ...
                    <div className={`transition-all duration-500 ${isActive ? 'opacity-100 translate-x-0' : 'opacity-50 lg:-translate-x-4 group-hover:opacity-80'}`}>
                      <div className="flex items-center gap-3 mb-3">
                        <div className={`w-8 h-8 rounded-lg flex items-center justify-center text-xs font-bold font-mono transition-colors duration-500 ${isActive ? 'bg-cyan-500/20 border border-cyan-400 text-cyan-400' : 'bg-[#0b1120] border border-gray-800 text-gray-500'}`}>
                          {step.num}
                        </div>
                        <h3 className="text-lg sm:text-xl font-bold text-white tracking-wide">{step.title}</h3>
                      </div>
                      <p className="text-xs sm:text-sm text-gray-400 leading-relaxed font-light mb-3">{step.description}</p>
                      
                      <div className={`overflow-hidden transition-all duration-500 ${isActive ? 'max-h-40 opacity-100' : 'max-h-0 opacity-0'}`}>
                        <div className="p-3 rounded-xl border border-gray-800/80 bg-[#0b1120]/50 shadow-inner mt-2">
            ...
            {/* Orbit Mapping Box (Hidden under large layout breakpoint to maximize mobile reading flow) */}
      ...
      {/* --- CTA VIDEO SECTION --- */}
      <section className="relative py-20 md:py-28 border-t border-gray-900 bg-[#02050B] overflow-hidden">
        ...
        <Reveal className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 text-center flex flex-col items-center">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-gray-800 bg-[#0b1120]/80 backdrop-blur-sm mb-6 sm:mb-8">
          ...
          <h2 className="text-2xl sm:text-4xl md:text-5xl font-extrabold text-white tracking-tight leading-[1.2] mb-4 sm:mb-6">
            Ready to <span className="text-cyan-400">Transform</span><br />
            Your Business with AI?
          </h2>

          <p className="text-gray-400 text-xs sm:text-sm md:text-base font-light max-w-2xl leading-relaxed mb-8 sm:mb-10">
      ...
      {/* TEAM SECTION */}
      {isTeamVisible && (
        <section id="team" className="py-16 md:py-24 border-t border-gray-900 bg-[#030712]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <Reveal className="text-center max-w-3xl mx-auto mb-12 space-y-2">
              <h2 className="text-2xl sm:text-4xl font-bold tracking-tight text-white">The Minds Behind Code&Bugs</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 sm:gap-6 justify-center">
              {team.map((member, index) => (
                <Reveal key={index} delay={index * 100} className="bg-[#0b1120]/40 border border-gray-900 rounded-2xl overflow-hidden group hover:border-cyan-500/30 transition-all duration-300 flex flex-col justify-between p-6 sm:p-8 text-center shadow-lg">
                  <div className="w-16 h-16 sm:w-24 sm:h-24 mx-auto rounded-full bg-gradient-to-br from-[#121b2e] to-[#080d1a] border border-gray-800 flex items-center justify-center group-hover:border-cyan-500/30 transition-all duration-300 mb-6">
                    <span className="text-lg sm:text-2xl font-bold tracking-wider text-gray-400 group-hover:text-cyan-400 font-mono">{member.initials}</span>
                  </div>
                  <div className="space-y-1.5 flex-1 flex flex-col justify-end">
                    <h3 className="text-base sm:text-lg font-bold text-white tracking-wide group-hover:text-cyan-400 transition-colors">{member.name}</h3>
                    <p className="text-[10px] sm:text-[11px] text-gray-500 font-mono tracking-wider uppercase pb-3">{member.role}</p>
                    <div className="flex items-center justify-center gap-3 pt-3 border-t border-gray-900 w-full text-[10px] text-gray-600 font-mono">
      ...
      {/* CONTACT SECTION WITH INPUT ADJUSTMENTS */}
      <section id="contact" className="py-16 md:py-24 border-t border-gray-900 bg-[#030712]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <Reveal className="mb-10 text-center lg:text-left">
            <h2 className="text-2xl sm:text-4xl font-extrabold text-white mb-2">Start a conversation</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 md:gap-8 items-start">
            ...
            {/* Input Form Box */}
            <Reveal delay={100} className="lg:col-span-7 bg-[#0b1120] border border-gray-800/80 rounded-3xl p-5 sm:p-8 lg:p-10 shadow-2xl">
              {!submitted ? (
                <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5">
                    <input type="text" required value={formData.name} onChange={e => setFormData({...formData, name: e.target.value})} className="w-full bg-[#030712] border border-gray-800 rounded-xl px-4 py-3.5 text-xs sm:text-sm text-white focus:outline-none focus:border-cyan-500 transition-colors placeholder:text-gray-600" placeholder="Your Name" />
                    <input type="email" required value={formData.email} onChange={e => setFormData({...formData, email: e.target.value})} className="w-full bg-[#030712] border border-gray-800 rounded-xl px-4 py-3.5 text-xs sm:text-sm text-white focus:outline-none focus:border-cyan-500 transition-colors placeholder:text-gray-600" placeholder="Email Address" />
                  </div>
                  <input type="text" value={formData.subject} onChange={e => setFormData({...formData, subject: e.target.value})} className="w-full bg-[#030712] border border-gray-800 rounded-xl px-4 py-3.5 text-xs sm:text-sm text-white focus:outline-none focus:border-cyan-500 transition-colors placeholder:text-gray-600" placeholder="Subject (optional)" />
                  <textarea required rows={5} value={formData.project} onChange={e => setFormData({...formData, project: e.target.value})} className="w-full bg-[#030712] border border-gray-800 rounded-xl px-4 py-3.5 text-xs sm:text-sm text-white focus:outline-none focus:border-cyan-500 transition-colors resize-none placeholder:text-gray-600" placeholder="Tell us about your project..." />
                  <button type="submit" className="w-full py-3.5 text-xs sm:text-sm font-bold text-[#030712] bg-cyan-500 hover:bg-cyan-400 rounded-xl transition-colors shadow-lg shadow-cyan-500/10">Send Message →</button>
                  <p className="text-center text-[11px] text-gray-500 font-light mt-3">Or chat directly on <a href="https://wa.me/923286403604" className="text-cyan-400 hover:underline">WhatsApp</a></p>
                </form>
              ) : (
                <div className="text-center py-12 space-y-3">
                  <div className="w-12 h-12 bg-cyan-500/10 border border-cyan-500/30 rounded-full flex items-center justify-center mx-auto text-cyan-400 mb-4"><ShieldCheck className="w-6 h-6" /></div>
            ...
            <Reveal delay={300} className="lg:col-span-5 space-y-4 w-full">
              
              <div className="p-5 sm:p-6 bg-gradient-to-br from-[#0b1120] to-[#080d1a] border border-cyan-500/20 rounded-2xl relative overflow-hidden group">
                 ...
                 <p className="text-[11px] sm:text-xs text-gray-400 font-light mb-4">Pick a 30-min slot on our calendar to discuss your project requirements in detail.</p>
                 <a href="https://calendly.com/dev-moazamsultan/30min" target="_blank" rel="noopener noreferrer" className="w-full inline-flex items-center justify-center py-2.5 text-xs font-bold text-[#030712] bg-cyan-400 hover:bg-cyan-300 rounded-xl transition-all shadow-md">
                   Book a Time <ArrowUpRight className="w-3 h-3 ml-1" />
                 </a>
              </div>

              <a href="https://wa.me/923286403604" className="flex items-center justify-between p-5 bg-[#0b1120] border border-gray-800/80 rounded-2xl hover:border-gray-700 transition-colors group">
                <div className="flex items-center gap-3.5">
                  <div className="w-9 h-9 rounded-full bg-[#030712] flex items-center justify-center border border-gray-800"><MessageCircle className="w-4 h-4 text-gray-400" /></div>
              ...
              <a href="mailto:contact@codeandbugs.com" className="flex items-center justify-between p-5 bg-[#0b1120] border border-gray-800/80 rounded-2xl hover:border-gray-700 transition-colors group">
                <div className="flex items-center gap-3.5">
                  <div className="w-9 h-9 rounded-full bg-[#030712] flex items-center justify-center border border-gray-800"><Mail className="w-4 h-4 text-cyan-400" /></div>
      ...
      {/* FOOTER GRID */}
      <footer className="border-t border-gray-900 bg-[#02050B] pt-16 pb-8 px-4 sm:px-6">
        <Reveal className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-6 mb-12">
            ...
            <div>
              <h4 className="text-white font-bold tracking-widest text-[10px] uppercase mb-4">Services</h4>
            ...
            <div>
              <h4 className="text-white font-bold tracking-widest text-[10px] uppercase mb-4">Company</h4>
              <ul className="space-y-2.5 text-xs sm:text-sm font-light">
            ...
            <div>
              <h4 className="text-white font-bold tracking-widest text-[10px] uppercase mb-4">Contact</h4>
              <ul className="space-y-2.5 text-xs sm:text-sm font-light">
          ...
          <div className="border-t border-gray-900 pt-6 flex flex-col sm:flex-row justify-between items-center gap-3 text-center sm:text-left">
