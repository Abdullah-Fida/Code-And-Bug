...
export default function Chatbot() {
  ...
  const handleSend = async () => {
    ...
    setInput("");
    setIsLoading(true); // Loading animation on karein
    ...
    try {
      ...
      // Bot ka real jawab screen par show karein
      ...
      setIsLoading(false); // Loading animation off karein
    }
  };
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end">
      ...
      {/* Chat Window */}
      {isOpen && (
        <div className="w-80 sm:w-96 h-[450px] mb-4 bg-[#0a0f1e]/80 backdrop-blur-xl border border-[#06B6D4]/30 rounded-2xl shadow-[0_0_30px_rgba(6,182,212,0.15)] flex flex-col overflow-hidden transition-all duration-300">
